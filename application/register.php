<?php
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	    ...
	    if (empty($username_err) && empty($password_err) && empty($confirm_err)) {
			...
			$sequel = 'INSERT INTO user_passwords (email, password) VALUES (?,?)';

			if ($statement = $mysql_db->prepare($sequel)) {
...
<body>
	<main>
		<section class="container wrapper">
        	...
        	<p class="text-center">Please fill in your credentials to create an account.</p>
        	<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
        		<div class="form-group <?php (!empty($username_err))?'has_error':'';?>">
        			<label for="username">Email</label>
        			<input type="email" name="username" id="username" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control" value="<?php echo $username ?>">
				...
				<p>Back to the Homepage? <a href="index.html">Click Here</a>.</p>
